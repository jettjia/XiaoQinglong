...
Usage: python3 add_slide.py <unpacked_dir> <source>
...
Examples:
    python3 add_slide.py unpacked/ slide2.xml
    # Duplicates slide2, creates slide5.xml

    python3 add_slide.py unpacked/ slideLayout2.xml
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python3 add_slide.py <unpacked_dir> <source>", file=sys.stderr)
